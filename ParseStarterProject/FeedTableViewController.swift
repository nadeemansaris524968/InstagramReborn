...
class FeedTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        query?.findObjectsInBackgroundWithBlock({ (objects, error) in
            ...
            var getFollowedUsers = PFQuery(className: "followers")
            
            getFollowedUsers.whereKey("follower", equalTo: (PFUser.currentUser()?.objectId)!)
            
            getFollowedUsers.findObjectsInBackgroundWithBlock { (objects, error) in
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.postedImage.image = UIImage(named: "image-placeholder.png")
